...
custom_local_manifest = ".repo/manifests/snippets/prototype.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'raft')
custom_dependencies = "prototype.dependencies"
org_manifest = "prototype-os-devices"  # leave empty if org is provided in manifest
org_display = "prototype-os-devices"  # needed for displaying
